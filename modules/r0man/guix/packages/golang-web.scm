...
(define-public go-github-com-invopop-jsonschema
  (package
    ...
    (propagated-inputs (list go-github-com-pb33f-ordered-map-v2))
...
;; Trimmed-down variant of the upstream huma-v2 that keeps only the
;; default net/http adapter and its server-sent events helpers.  The
;; upstream package propagates adapters for many web frameworks (gin,
;; fiber, echo, ...) which drag in heavy dependencies (bytedance/sonic,
;; cloudwego/iasm) that fail to build on aarch64.
  ...
  (package
    ...
    (source
     (origin
       ...
       (snippet
        #~(begin
            ;; Drop adapters for web frameworks we do not need.  This
            ;; avoids pulling in gin/fiber/echo/chi and their large
            ;; dependency trees.
            (for-each delete-file-recursively
                      (list "adapters/humabunrouter"
                            "adapters/humachi"
                            "adapters/humaecho"
                            "adapters/humafiber"
                            "adapters/humaflow"
                            "adapters/humagin"
                            "adapters/humahttprouter"
                            "adapters/humamux"
                            "examples"))))))
    (build-system go-build-system)
    (arguments
    ...
    (propagated-inputs (list go-github-com-danielgtaylor-shorthand-v2
    ...
    (synopsis "REST/HTTP API Framework for Go")
    (description
     "Huma is a framework for building REST APIs in Go.  It generates
@code{OpenAPI} 3.1 specifications and JSON Schema documents describing
the API and provides a quick way to generate docs, mocks, SDKs, and
CLI clients.  This variant bundles only the default @code{net/http}
adapter and the server-sent events helpers.")
    (license license:expat)))
...
(define-public go-github-com-apapsch-go-jsonmerge-v2
  (package
    ...
    (synopsis "Merge JSON documents in Go")
    (description
     "This package provides functions for merging JSON documents in Go,
supporting both full and partial merges.")
    (license license:expat)))
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "03d8r4azy8234mf9cc2n564idbss9fxrmngwx3ilk3s05xysjx1d"))))
    (build-system go-build-system)
    (arguments
     (list
      #:tests? #f
      #:import-path "github.com/oapi-codegen/runtime"))
    (propagated-inputs (list go-github-com-apapsch-go-jsonmerge-v2
                             go-github-com-google-uuid))
    (home-page "https://github.com/oapi-codegen/runtime")
    (synopsis "Runtime library for oapi-codegen generated code")
    (description
     "This package provides runtime support for code generated by
@code{oapi-codegen}, including parameter binding, form handling, and
custom type conversions used by generated OpenAPI clients and servers.")
    (license license:asl2.0)))
