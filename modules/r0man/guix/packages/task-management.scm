...
(define-public beads-next
  (let ((commit "b4f5d2aa89ef9255a3cdd2595c80edbf2cdf0bc7")
        (revision "85"))
    (package
      (name "beads-next")
      ...
      (source
       (origin
         ...
         (sha256
          (base32 "0y404vskbnbz81k7xcli2mf02vn48izd89gzpv6j96z9xxkz1kzn"))))
...
(define-public gascity-next
  (let ((commit "71e5847e27bf5b605cff9dc8d80df61420ee585d")
        (revision "1753"))
    (package
      (name "gascity-next")
      (version (git-version "1.1.0" revision commit))
      (source
       (origin
         ...
         (file-name (git-file-name name version))
         (sha256
          (base32 "12q6bya11ik034mbk7j30axiy4w7lmlj3m0r5mcqk26lks1gb2c8"))))
      (build-system go-build-system)
      (arguments
       (list
        #:go go-1.26
