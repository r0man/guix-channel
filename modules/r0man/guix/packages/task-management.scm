...
(define-public beads-next
  (let ((commit "ff2f6154ab1ceff8f07343d889fd3ee01b58a771")
        (revision "90"))
    (package
      (name "beads-next")
      ...
      (source
       (origin
         ...
         (sha256
          (base32 "0bwzlyidjlqhm3f5qmva3p9lcls1h5qfqj2wimqpnh3y9kwxs5q9"))))
...
(define-public gascity-next
  (let ((commit "3203b502f6b28d3309fe1bf49f1c617fdbe1ed16")
        (revision "3623"))
    (package
      (name "gascity-next")
      (version (git-version "1.1.0" revision commit))
      (source
       (origin
         ...
         (file-name (git-file-name name version))
         (sha256
          (base32 "0f5rwn78kr54yfpns7i87l17gxl1kgx9qx63vd5hckmgxh6xknf3"))))
      (build-system go-build-system)
      (arguments
       (list
        #:go go-1.26
