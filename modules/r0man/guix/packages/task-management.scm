...
(define-public beads-next
  (let ((commit "6a6421740aa71cd53789c946888a037f5027c0eb")
        (revision "33"))
    (package
      (name "beads-next")
      ...
      (source
       (origin
         ...
         (sha256
          (base32 "128j8y5w3i6p2bcnbhd82m7iqmprygx0an4yn6aipbiy7mcfwddh"))))
...
(define-public gascity-next
  (let ((commit "5f1a686d940063573a7ac1ba979585296d37ba1f")
        (revision "1530"))
    (package
      (name "gascity-next")
      ...
      (source
       (origin
         ...
         (file-name (git-file-name name version))
         (sha256
          (base32 "0xj6g2p7dw9rlmazflkgpgwwmri0qxa3m132p72hs6p82f3qr10l"))))
      (build-system go-build-system)
      (arguments
       (list
        #:go go-1.26
