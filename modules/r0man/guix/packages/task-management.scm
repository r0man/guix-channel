...
(define-public beads-next
  (let ((commit "afcc5bbe40fb4921bf466bbdaaec2df75c09f550")
        (revision "89"))
    (package
      (name "beads-next")
      ...
      (source
       (origin
         ...
         (sha256
          (base32 "1031j6n88cgs9pc4ckn552404rbxiw77mv0pniaka5153wc864lb"))))
...
(define-public gascity-next
  (let ((commit "93e927a401249d27f127de587180980dbf4e0b6d")
        (revision "3536"))
    (package
      (name "gascity-next")
      (version (git-version "1.1.0" revision commit))
      (source
       (origin
         ...
         (file-name (git-file-name name version))
         (sha256
          (base32 "1i3awi04kf6hwnlby68plnmh1a0ygxvf3d69niizinp6s1qhwc46"))))
      (build-system go-build-system)
      (arguments
       (list
        #:go go-1.26
