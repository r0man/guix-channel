    ...
    (source
     (origin
       ...
       (sha256
        (base32 (cond
                  ((target-aarch64?)
                   "06rb63aq5a0n6zpbbm5vgsp2pqlzay1jsl2v69yjz0fmmhqzn0x5")
                  ((target-x86-64?)
                   "0d3fgpj9ap9h1kg4s6nnqxrlan25spcrmv922zfin42iwd7s6f1g")
                  (else "0d3fgpj9ap9h1kg4s6nnqxrlan25spcrmv922zfin42iwd7s6f1g"))))))
