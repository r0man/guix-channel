...
(define-public go-github-com-dolthub-go-icu-regex
  (package
    ...
    (version "0.0.0-20260412212219-49724d547866")
    (source
     (origin
       (method git-fetch)
       (uri (git-reference
             (url "https://github.com/dolthub/go-icu-regex")
             (commit "49724d547866ae82c34c4f15873008454ec814a1")))
       (file-name (git-file-name name version))
       (sha256
        (base32 "0w22akn9hqcd07gmgi0rkrb79v9l0h3167p012fzajsl4hasq33p"))))
    (build-system go-build-system)
    (arguments
     (list
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "0gpgbbil2cpgwys1dd15x0zlvmdy8sh8ny2klnpn1b2p6d3xcaay"))
       (modules '((guix build utils)))
       (snippet
...
(define-public go-github-com-dolthub-ishell
  (package
    ...
    (version "0.0.0-20260414231531-5f031e3e9037")
    (source
     (origin
       (method git-fetch)
       (uri (git-reference
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "1lsspwn3gnv5n2d5v36ybn7k1xk6zbkdj5ykc0rpina3jb75b634"))))
    (build-system go-build-system)
    (arguments
     (list
...
(define-public go-github-com-dolthub-vitess-for-dolt
  (package
    ...
    (version "0.0.0-20260914165732-909aa98f55b7")
    (source
     (origin
       (method git-fetch)
       (uri (git-reference
             (url "https://github.com/dolthub/vitess")
             (commit "909aa98f55b72751f16d2b0de72fe300d17bbbc4")))
       (file-name (git-file-name "go-github-com-dolthub-vitess"
                                 "0.0.0-20260914165732-909aa98f55b7"))
       (sha256
        (base32 "0wcppsr9wbbk0qapij4hzwj37q7qpvvp0hl7ailv832zax5yx5bs"))))))
...
(define-public go-github-com-dolthub-go-mysql-server-for-dolt
  (package
    ...
    (version "0.20.1-0.20260915233322-a939809e084d")
    (source
     (origin
       (method git-fetch)
       (uri (git-reference
             (url "https://github.com/dolthub/go-mysql-server")
             (commit "a939809e084d3d67214c53b5d2830771e34e7279")))
       (file-name (git-file-name "go-github-com-dolthub-go-mysql-server"
                                 "0.20.1-0.20260915233322-a939809e084d"))
       (sha256
        (base32 "1kg3hvphk2z3av8dwzcragkqjpbljybyhqsi0vcv6pjhd0ckbyk4"))))
    (propagated-inputs
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "1798a0p7prm6934a0yqd43pb4mbfmn7adny5gyx0c5vxvkyqnis2"))
       (modules '((guix build utils)))
       (snippet
        ;; Replace google.golang.org/grpc/experimental/credentials
        ;; (not available in grpc v1.69.2) with standard credentials.NewTLS
