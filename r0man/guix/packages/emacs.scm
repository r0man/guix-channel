...
(define-public emacs-copilot
  (let ((commit "d4fa14cea818e041b4a536c5052cf6d28c7223d7"))
    (package
      (name "emacs-copilot")
      ...
      (source
       (origin
         ...
         (sha256
          (base32 "1bn2im5ybzmwbwbi7v39s0qzmca5isp7zb0ls61y6sramh6k8fsg"))))
      (build-system emacs-build-system)
      (arguments
       (list
        #:phases
...
(define-public emacs-ellama
  (package
    (name "emacs-ellama")
    (version "20231116.2010")
    (source (origin
              (method git-fetch)
              (uri (git-reference
                    (url "https://github.com/s-kostyaev/ellama.git")
                    (commit "b8ef883fb8a95c64256a8a4bfa6bc79497009b4a")))
              (sha256 (base32
                       "00vs1sap5g15gv52zp0yv8rsfxggsd988i6rqsyg5527cb4bxl6z"))))
    (build-system emacs-build-system)
