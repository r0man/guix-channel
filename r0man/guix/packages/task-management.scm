...
(define-public beads-next
  (let ((commit "0fffa44a2302a496dfa4ffa838843b3bbf0ee122")
        (revision "28"))
    (package
      (name "beads-next")
      ...
      (source
       (origin
         ...
         (sha256
          (base32 "1rxpbcfbmj62fbb5dir97zpqm6p329zlh96rjq9qbqkhkd10mg6v"))))
...
(define-public gascity-next
  (let ((commit "3341b5a5bdaaade83d68b237e7b8e095de58c106")
        (revision "1136"))
    (package
      (name "gascity-next")
      (version (git-version "1.0.0" revision commit))
      (source
       (origin
         ...
         (file-name (git-file-name name version))
         (sha256
          (base32 "0yqdywnr37jnzfin8hvrq9gsadqpl3pr6l8cdzp8r3ig4g91ydy2"))))
      (build-system go-build-system)
      (arguments
       (list
        #:go go-1.26
