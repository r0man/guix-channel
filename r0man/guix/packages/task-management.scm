...
(define-public beads-next
  (let ((commit "cf88aa760d73191681c64f6b2407c43e37e5cc2f")
        (revision "26"))
    (package
      (name "beads-next")
      ...
      (source
       (origin
         ...
         (sha256
          (base32 "1yil1d2zisnqkmjlazwsf3mka7ss2yfm2ykign1znv995xfk13qv"))))
...
(define-public gascity-next
  (let ((commit "4369b2f86c6164c8aaafb385624ecc0cadcdc729")
        (revision "1104"))
    (package
      (name "gascity-next")
      (version (git-version "1.0.0" revision commit))
      (source
       (origin
         ...
         (file-name (git-file-name name version))
         (sha256
          (base32 "04b7rviia4bfpcm00s917igl0da9i2rllhjspms868i8gzca398r"))))
      (build-system go-build-system)
      (arguments
       (list
        #:go go-1.26
