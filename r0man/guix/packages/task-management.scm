...
(define-public beads-next
  (let ((commit "674561360d7cd98a4e00fb5993bec4720375b043")
        (revision "29"))
    (package
      (name "beads-next")
      ...
      (source
       (origin
         ...
         (sha256
          (base32 "0lm2hcrn1321q18vnsmw327rghylk2scaqsnjaijsvzj7nrv0pj0"))))
...
(define-public gascity-next
  (let ((commit "a4d32733a4b697c0d8a76e5388f3e9a9fe257d84")
        (revision "1208"))
    (package
      (name "gascity-next")
      (version (git-version "1.0.0" revision commit))
      (source
       (origin
         ...
         (file-name (git-file-name name version))
         (sha256
          (base32 "06aykq88rw2268225v4fh957rmhnxqga49cal92a03qq787asjmr"))))
      (build-system go-build-system)
      (arguments
       (list
        #:go go-1.26
